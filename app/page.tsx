                ...
                >
                  ...
                  <div className="flex justify-center space-x-3 relative z-10">
                    <a href="https://www.linkedin.com/in/abhik-ghosh-msc/" target="_blank" rel="noopener noreferrer" 
                       className="relative z-10 w-10 h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white hover:bg-blue-700 transition-colors">
                    ...
                    <a href="https://www.xing.com/profile/Abhik_Ghosh" target="_blank" rel="noopener noreferrer" 
                       className="relative z-10 w-10 h-10 bg-green-600 rounded-lg flex items-center justify-center text-white hover:bg-green-700 transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                    ...
                    <a href="https://www.credly.com/users/abhik-ghosh.941f4a38/badges#credly" target="_blank" rel="noopener noreferrer" 
                       className="relative z-10 w-10 h-10 bg-orange-500 rounded-lg flex items-center justify-center text-white hover:bg-orange-600 transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
                    ...
                    <a href="https://github.com/abhikghosh12" target="_blank" rel="noopener noreferrer" 
                       className="relative z-10 w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center text-white hover:bg-gray-900 transition-colors">
                      <svg width="20" height="20" viewBox="0 0 24 24" fill="white">
