                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4 mb-4">
                          ...
                          {job.company === 'JSW Energy' && (
                            <div className="w-24 h-24 rounded-lg border border-gray-200 flex-shrink-0 bg-white p-4 flex items-center justify-center">
                              <img 
                                src="/Certificates/logos/jsw.jpeg" 
                                alt="JSW Energy" 
                                className="w-full h-full object-contain"
                              />
                            </div>
                          ...
                          {job.company === 'Universitätsklinikum Augsburg' && (
                            <div className="w-24 h-24 rounded-lg border border-gray-200 flex-shrink-0 bg-white p-4 flex items-center justify-center">
                              <img 
                                src="/Certificates/logos/uniklinik.png" 
                          ...
                          {job.company === 'RWTH Aachen University' && (
                            <div className="w-24 h-24 rounded-lg border border-gray-200 flex-shrink-0 bg-white p-4 flex items-center justify-center">
                              <img 
                                src="/Certificates/logos/rwth.png" 
                      ...
                      <div className="flex-1">
                        <div className="flex items-start gap-4 mb-4">
                          {edu.institution === 'Otto-von-Guericke-Universität' && (
                            <div className="w-24 h-24 rounded-lg border border-gray-200 flex-shrink-0 bg-white p-4 flex items-center justify-center">
                              <img 
                                src="/Certificates/logos/otto-von-guericke.png" 
                                alt="Otto-von-Guericke-Universität" 
                                className="w-full h-full object-contain"
                              />
                            </div>
                          )}
                          {edu.institution === 'Visveswaraiah Technological University' && (
                            <div className="w-24 h-24 rounded-lg border border-gray-200 flex-shrink-0 bg-white p-4 flex items-center justify-center">
                              <img 
                                src="/Certificates/logos/vtu.jpeg" 
                                alt="Visveswaraiah Technological University" 
                                className="w-full h-full object-contain"
                              />
                            </div>
                          )}
