                ...
                <div className="mt-6 pt-6 border-t border-gray-100">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a href="https://www.credly.com/users/abhik-ghosh.941f4a38/badges#credly" target="_blank" rel="noopener noreferrer" 
                       title="Credly Badges"
                       className="w-10 h-10 bg-white rounded-lg border border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-colors p-2">
                      <img src="/Certificates/c.png" alt="Credly" className="w-6 h-6 object-contain" />
                    </a>
                  </div>
                </div>
              </motion.div>
