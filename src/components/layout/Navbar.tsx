          ...
          <div className="hidden lg:flex items-center space-x-2">
            ...
            <div className="flex items-center space-x-1">
              <a href="https://www.linkedin.com/in/abhik-ghosh-m-sc-61539425/" target="_blank" rel="noopener noreferrer" 
                 className="w-6 h-6 bg-[#0077B5] rounded flex items-center justify-center hover:scale-110 transition-transform" title="LinkedIn">
              ...
              <a href="https://www.xing.com/profile/Abhik_Ghosh?sc_o=mxb_p" target="_blank" rel="noopener noreferrer"
                 className="w-6 h-6 bg-[#006567] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Xing">
                <span className="text-white text-xs font-bold">X</span>
              </a>
              
              <a href="tel:+4917665979446"
                 className="w-6 h-6 bg-[#4CAF50] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Phone">
                <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/4917665979446" target="_blank" rel="noopener noreferrer"
                 className="w-6 h-6 bg-[#25D366] rounded flex items-center justify-center hover:scale-110 transition-transform" title="WhatsApp">
                <span className="text-white text-xs">💬</span>
              </a>
              
              <a href="mailto:abhikghosh@outlook.com"
                 className="w-6 h-6 bg-[#EA4335] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Email">
                <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.credly.com/users/abhik-ghosh.941f4a38" target="_blank" rel="noopener noreferrer"
                 className="w-6 h-6 bg-[#FF6B00] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Credly">
                <span className="text-white text-xs font-bold">C</span>
              </a>
              
              <a href="https://medium.com/@abhikghosh_46536" target="_blank" rel="noopener noreferrer"
                 className="w-6 h-6 bg-[#000000] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Medium">
                <span className="text-white text-xs font-bold">M</span>
              </a>
              
              <a href="https://github.com/abhikghosh12" target="_blank" rel="noopener noreferrer"
                 className="w-6 h-6 bg-[#333333] rounded flex items-center justify-center hover:scale-110 transition-transform" title="GitHub">
                <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 24 24">
