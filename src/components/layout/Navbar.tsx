          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-1">
              ...
              <a href="https://www.linkedin.com/in/abhik-ghosh-m-sc-61539425/" target="_blank" rel="noopener noreferrer" 
                 className="w-8 h-8 bg-[#0077B5] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="LinkedIn">
              ...
              <a href="https://www.xing.com/profile/Abhik_Ghosh?sc_o=mxb_p" target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#006567] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="Xing">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="tel:+4917665979446"
                 className="w-8 h-8 bg-[#4CAF50] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="Phone">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/4917665979446" target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#25D366] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="WhatsApp">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:abhikghosh@outlook.com"
                 className="w-8 h-8 bg-[#EA4335] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="Email">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.credly.com/users/abhik-ghosh.941f4a38" target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#FF6B00] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="Credly">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://medium.com/@abhikghosh_46536" target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#000000] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="Medium">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://github.com/abhikghosh12" target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#333333] rounded border border-gray-200 flex items-center justify-center hover:scale-110 transition-transform" title="GitHub">
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
