          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center space-x-1">
              <a href="https://www.linkedin.com/in/abhik-ghosh-m-sc-61539425/" 
                 ...
                 className="w-8 h-8 bg-[#0077B5] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
              ...
              <a href="https://www.xing.com/profile/Abhik_Ghosh?sc_o=mxb_p" 
                 target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#006567] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                <span className="text-white font-bold text-sm">X</span>
              </a>
              
              <a href="tel:+4917665979446"
                 className="w-8 h-8 bg-[#4CAF50] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="mailto:abhikghosh@outlook.com"
                 className="w-8 h-8 bg-[#0078D4] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.credly.com/users/abhik-ghosh.941f4a38" 
                 target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#FF6B00] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                <span className="text-white font-bold text-xs">Credly</span>
              </a>
              
              <a href="https://medium.com/@abhikghosh_46536" 
                 target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#000000] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
                <span className="text-white font-bold text-sm">M</span>
              </a>
              
              <a href="https://github.com/abhikghosh12" 
                 target="_blank" rel="noopener noreferrer"
                 className="w-8 h-8 bg-[#333333] rounded-full flex items-center justify-center hover:opacity-80 transition-opacity">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
