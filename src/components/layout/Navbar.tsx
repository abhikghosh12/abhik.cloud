...
const Navbar: React.FC = () => {
  ...
  return (
    <nav 
      className={`fixed top-0 left-0 right-0 z-50 h-10 transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 h-full">
        <div className="flex justify-between items-center h-full">
          ...
          <div className="flex items-center flex-shrink-0">
            <Link to="/" className="text-sm font-bold text-gradient">
              Abhik Ghosh
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-4 flex-1 justify-center">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.path}
                className={`text-xs font-medium transition-colors px-1 py-0.5 rounded whitespace-nowrap ${
          ...
          <div className="hidden lg:flex items-center space-x-2 flex-shrink-0">
            ...
            <div className="flex items-center space-x-0.5">
              <a href="https://www.linkedin.com/in/abhik-ghosh-m-sc-61539425/" target="_blank" rel="noopener noreferrer" 
                 className="w-3.5 h-3.5 bg-[#0077B5] rounded flex items-center justify-center hover:scale-110 transition-transform" title="LinkedIn">
              ...
              <a href="https://www.xing.com/profile/Abhik_Ghosh?sc_o=mxb_p" target="_blank" rel="noopener noreferrer"
                 className="w-3.5 h-3.5 bg-[#006567] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Xing">
                <span className="text-white text-[8px] font-bold">X</span>
              </a>
              
              <a href="tel:+4917665979446"
                 className="w-3.5 h-3.5 bg-[#4CAF50] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Phone">
                <svg className="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://wa.me/4917665979446" target="_blank" rel="noopener noreferrer"
                 className="w-3.5 h-3.5 bg-[#25D366] rounded flex items-center justify-center hover:scale-110 transition-transform" title="WhatsApp">
                <span className="text-white text-[8px]">💬</span>
              </a>
              
              <a href="mailto:abhikghosh@outlook.com"
                 className="w-3.5 h-3.5 bg-[#EA4335] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Email">
                <svg className="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.credly.com/users/abhik-ghosh.941f4a38" target="_blank" rel="noopener noreferrer"
                 className="w-3.5 h-3.5 bg-[#FF6B00] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Credly">
              ...
              <a href="https://medium.com/@abhikghosh_46536" target="_blank" rel="noopener noreferrer"
                 className="w-3.5 h-3.5 bg-[#000000] rounded flex items-center justify-center hover:scale-110 transition-transform" title="Medium">
                <span className="text-white text-[8px] font-bold">M</span>
              </a>
              
              <a href="https://github.com/abhikghosh12" target="_blank" rel="noopener noreferrer"
                 className="w-3.5 h-3.5 bg-[#333333] rounded flex items-center justify-center hover:scale-110 transition-transform" title="GitHub">
                <svg className="w-2 h-2 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <Link
              to="/appointment"
              className="bg-[#E91E63] text-white px-2 py-0.5 rounded-full text-xs font-medium hover:bg-[#AD1457] transition-colors whitespace-nowrap"
            >
              Contact me!
            </Link>
