...
const Navbar: React.FC = () => {
  ...
  const socialLinks = [
    ...
    {
      name: 'Email',
      url: 'mailto:abhikghosh@outlook.com',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <span className="text-2xl font-bold text-gradient">Abhik Ghosh</span>
            </Link>
          </div>
          ...
          <div className="lg:hidden flex items-center">
            <button
              ...
              className="text-gray-600 hover:text-[#E91E63] focus:outline-none focus:text-[#E91E63]"
            >
              {isOpen ? (
